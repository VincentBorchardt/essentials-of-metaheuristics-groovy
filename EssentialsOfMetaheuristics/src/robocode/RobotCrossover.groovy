...
class RobotCrossover {
	...
	def crossover = {parent1, parent2, chance = defaultChance, maxDepth = defaultMaxDepth ->
		def new_id1 = random.nextInt(100000000)
		def new_id2 = random.nextInt(100000000)
		...
		def new_values1 = ["id" : new_id1, "aimingFunctionTree" : new_tree1, "predictiveAimingFunction" : new_tree1.toString()]
		def new_values2 = ["id" : new_id2, "aimingFunctionTree" : new_tree2, "predictiveAimingFunction" : new_tree2.toString()]
