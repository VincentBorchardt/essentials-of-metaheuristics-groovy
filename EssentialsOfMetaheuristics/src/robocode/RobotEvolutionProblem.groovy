...
class RobotEvolutionProblem {
	protected rand = new java.util.Random()
	def maximalQuality = { 100 }
	...
	def create = {
		...
		def enemy_energy = random.nextFloat() * 100
		def my_energy = random.nextFloat() * 100
		def angle_diff = random.nextFloat() * 100
		def distance = random.nextFloat() * 100
